            ...
            <div className="animation">
                ...
                <div offset={0} speed={0.5} >
                    <div className="contentblock" >
                        <div className='head'>Material Science</div>




                        <div className='infoblock1' >
                            <h2>Materials Technology for Electric Vehicles (EVs):</h2>
                            {/* <h3>Description</h3>
                            ...
                            <p>This theme focuses on development and implementation of materials driving the EV revolution such as cutting-edge battery technologies, lightweight structural components, and advanced thermal management systems. These developments and specialized materials are critical for increasing the range, safety, and overall efficiency of electric vehicles enabling sustainable transportation that can be made accessible to all.</p>
                        </div>
                        <div className='infoblock2' >
                            <h2>Advanced Materials for Durability, Safety and Sustainability to Improve Performance of Automotive Vehicles</h2>
                            <p>This theme explores the rise of lighter and stronger materials in automotive design and engineering, sustainable materials which are reducing the environmental impact of vehicle production, innovative manufacturing processes, Materials challenges in meeting stringent safety standards and improving efficiency.</p>
                        </div>
