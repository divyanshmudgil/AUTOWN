        ...
        <div className="App4">
            <nav >
                <ul >
                    ...
                    <li>
                        <a href='/exploreacs'>MATERIAL SCIENCE</a>
                    </li>
                    <li>
                        <a href='/exploreadas'>ADAS</a>
                    </li>
                    <li>
                        <a href='/exploreev'>ELECTRIC VEHICLE</a>
                    </li>
                    {/* <li>
            ...
            <div  className="animation">
                    <div className="contentblock" >
                        ...
                        <div className='infoblock1' >
                            <h2>Adaptive Cruise Control: Real-Time Speed Adjustment for Traffic Flow</h2>
                            {/* <h3>Description</h3>
                            ...
                            <p>
                            Design a system that adjusts the speed of a vehicle automatically based on real-time traffic conditions using sensor data and machine learning algorithms.
                            </p>
                        </div>
                        <div className='infoblock2' >
                            <h2>Maze Navigator: Autonomous Route Optimization in Complex Environments</h2>
                            {/* <h3>Description</h3>
                            <p><span className='heading'>Introduction</span>:
                            ...
                            <p>
                            Design a small automated driving system that can navigate through mazes and optimize the route.
                            </p>
                        </div>
                        ...
                        <div className='infoblock1' >
                            <h2>Voice-Activated Car Control: Seamless Hands-Free Driving Experience</h2>
                            {/* <h3>Description</h3>
                            <p><span className='heading'>Introduction</span>:
                            ...
                            <p>
                            Develop a voice recognition system that allows drivers to control various car features (e.g., navigation, music) through voice command.
                            </p>
                        </div>

                        <div className='infoblock2' >
                            <h2>Predictive Vehicle Health: AI-Driven Maintenance Alerts</h2>
                            {/* <h3>Description</h3>
                            <p><span className='heading'>Introduction</span>:
                            ...
                            <p><span className='heading'>OBD-II System Understanding:</span>
                                ...
                                <p>
                                    Build a model that predicts potential vehicle issues based on sensor data, such as engine performance metrics, to schedule timely maintenance.
                        ...
                        <div className='infoblock1' >
                            <h2>Smart License Plate Recognition: Efficient Tolling and Parking Solutions</h2>
                            {/* <h3>Description</h3>
                            <p><span className='heading'>Introduction</span>:
                            ...
                            <p><span className='heading'>Sensor Integration: </span>
                                ...
                                <p>Implement an AI system to recognize and read license plates from images or video feeds. This can be useful for automatic toll collection or parking management.</p>
                        </div>


                        <div className='infoblock2' >
                            <h2>Obstacle-Aware Autonomous Navigation: Smart Car Pathfinding</h2>
                            {/* <h3>Description</h3>
                            <p><span className='heading'>Introduction</span>:
                            ...
                            <p><span className='heading'>Vehicle Systems Understanding:</span>
                                ...
                                <p>Design a smart car that can autonomously navigate between two points while avoiding obstacles along the way.</p>
                        </div>

                        <div className='infoblock1' >
                            <h2>Multi-Sensor Collision Avoidance: Integrating Radar, LiDAR, and Cameras for Enhanced Safety</h2>
                            {/* <h3>Description</h3>
                            <p><span className='heading'>Introduction</span>:
                            ...
                            <p><span className='heading'>Automotive Systems Understanding:</span>
                                ...
                                <p>Develop a system that fuses data from radar, LiDAR, and camera sensors to accurately detect and avoid potential collisions.</p>
                        </div>

                        <div className='infoblock2' >
                            <h2>Vehicle Localization and Mapping: Combining GPS, IMU, LiDAR, and Camera Inputs for Precise Positioning</h2>
                            <p>Design a localization system that fuses GPS, IMU, LiDAR, and Camera data to provide accurate vehicle positioning and mapping in complex environments.</p>
                        </div>

                        <div className='infoblock1' >
                            <h2>Troubleshooting Assistance Using AI Chatbot:</h2>
                            <p>Design a chatbot that can provide diagnostic assistance by asking users about symptoms and offering potential solutions or recommending a visit to a service center.</p>
                        </div>

                        <div className='infoblock2' >
                            <h2>Automated Fleet Scheduling:</h2>
                            <p>Implement AI algorithms to automate the scheduling of vehicles and drivers based on demand, availability, and regulatory constraints. This helps optimize fleet utilization and reduce operational costs.</p>
                        </div>

                        <div className='infoblock1' >
                            {/* <h2>Vehicle Localization and Mapping: Combining GPS, IMU, LiDAR, and Camera Inputs for Precise Positioning</h2> */}
                            <p>Note: Please note that the topics provided above are merely suggestions for student projects. Students are encouraged to select and present any project of their own interest within the areas of ADAS, AI in Automobiles, and Automotive Security. Additionally, it is recommended to include a testbed or prototype during your demonstration at the event.</p>
                        </div>
